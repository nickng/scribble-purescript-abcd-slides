...
(function(exports) {
  ...
  var Disable = (function () {
      function Disable(value0) {
          this.value0 = value0;
      };
      Disable.create = function (value0) {
          return new Disable(value0);
      };
      return Disable;
  })();
      ...
      var $$eval = function (v) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Ace.editNode(v1.value0)(Ace.ace)))(function (v2) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Ace_Editor.getSession(v2)))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                  var $20 = {};
                                  for (var $21 in v4) {
                                      if ({}.hasOwnProperty.call(v4, $21)) {
                                          $20[$21] = v4[$21];
                                      };
                                  };
                                  $20.editor = new Data_Maybe.Just(v2);
                                  return $20;
                              }))(function () {
                                  return Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.eventSource_(Effect_Aff_Class.monadAffAff)(Ace_EditSession.onChange(v3))(Halogen_Query.request(HandleChange.create)));
                              });
                          });
                      });
                  };
                  throw new Error("Failed pattern match at AceComponent line 62, column 50 - line 68, column 91: " + [ v1.constructor.name ]);
              }))(function () {
          ...
          if (v instanceof Finalize) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $25.editor = Data_Maybe.Nothing.value;
                  return $25;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          ...
          if (v instanceof Enable) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Ace_Editor.setReadOnly(false)(v1.value0));
                      };
                      throw new Error("Failed pattern match at AceComponent line 77, column 7 - line 79, column 70: " + [ v1.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          ...
          if (v instanceof Disable) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Ace_Editor.setReadOnly(true)(v1.value0));
                      };
                      throw new Error("Failed pattern match at AceComponent line 83, column 7 - line 85, column 69: " + [ v1.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          ...
          if (v instanceof ChangeText) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at AceComponent line 89, column 7 - line 94, column 70: " + [ v1.constructor.name ]);
                  })())(function () {
          ...
          if (v instanceof HandleChange) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at AceComponent line 99, column 7 - line 103, column 37: " + [ v1.constructor.name ]);
                  })())(function () {
          ...
          throw new Error("Failed pattern match at AceComponent line 60, column 10 - line 104, column 30: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var decodeRepArgsArgument = function (dictDecodeJson) {
      return new DecodeRepArgs(function (js) {
          return Control_Bind.bind(Data_Either.bindEither)(mFail("too few values were present")(Data_Array.uncons(js)))(function (v) {
              return Data_Functor.map(Data_Either.functorEither)(function ($74) {
                  return (function (v1) {
                      return {
                          init: v1,
                          rest: v.tail
                      };
                  })(Data_Generic_Rep.Argument($74));
      ...
      return function (dictDecodeRepArgs) {
          return new DecodeRep(function (j) {
              ...
              return Control_Bind.bind(Data_Either.bindEither)(mFail(decodingErr("expected an object"))(Data_Argonaut_Core.toObject(j)))(function (v) {
                  return Control_Bind.bind(Data_Either.bindEither)(mFail(decodingErr("'tag' property is missing"))(Foreign_Object.lookup("tag")(v)))(function (v1) {
                      return Control_Bind.bind(Data_Either.bindEither)(mFail(decodingErr("'tag' property is not a string"))(Data_Argonaut_Core.toString(v1)))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Data_Either.bindEither)(Control_Applicative.when(Data_Either.applicativeEither)(v2 !== name)(Data_Either.Left.create(decodingErr("'tag' property has an incorrect value"))))(function () {
                              return Control_Bind.bind(Data_Either.bindEither)(mFail(decodingErr("'values' property is missing"))(Foreign_Object.lookup("values")(v)))(function (v3) {
  ...
  var genericDecodeJson = function (dictGeneric) {
      return function (dictDecodeRep) {
          return function ($75) {
              return Data_Functor.map(Data_Either.functorEither)(Data_Generic_Rep.to(dictGeneric))(decodeRep(dictDecodeRep)($75));
          };
      };
  };
...
(function(exports) {
  ...
  var encodeRepConstructor = function (dictIsSymbol) {
      return function (dictEncodeRepArgs) {
          return new EncodeRep(function (v) {
              return Data_Argonaut_Core.fromObject(Foreign_Object.insert("tag")(Data_Argonaut_Core.fromString(Data_Symbol.reflectSymbol(dictIsSymbol)(Data_Symbol.SProxy.value)))(Foreign_Object.insert("values")(Data_Argonaut_Core.fromArray(encodeRepArgs(dictEncodeRepArgs)(v)))(Foreign_Object.empty)));
          });
      };
  };
  ...
  var genericEncodeJson = function (dictGeneric) {
      return function (dictEncodeRep) {
          return function ($56) {
              return encodeRep(dictEncodeRep)(Data_Generic_Rep.from(dictGeneric)($56));
          };
      };
  };
...
})(PS["Graphics.Viz"] = PS["Graphics.Viz"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var $foreign = PS["Graphics.Viz"];
  var Data_Function_Uncurried = PS["Data.Function.Uncurried"];
  var Data_Show = PS["Data.Show"];
  var Prelude = PS["Prelude"];                 
  var SVG = (function () {
  ...
  var showFormat = new Data_Show.Show(function (v) {
      return "svg";
  });
  var viz = function (d) {
      return function (f) {
          return $foreign._viz(d, Data_Show.show(showFormat)(f));
      };
  };
  exports["SVG"] = SVG;
  exports["viz"] = viz;
...
(function(exports) {// Taken from https://gist.github.com/prathje/7422e49b7c809fe8236bb2f213e7076e
...
})(PS["Halogen.Component.Raw"] = PS["Halogen.Component.Raw"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var $foreign = PS["Halogen.Component.Raw"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Category = PS["Control.Category"];
  var Control_Monad_State_Class = PS["Control.Monad.State.Class"];
  ...
  var rawComponent = (function () {
      var updateHTML = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
          return v.elRef;
      }))(function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(v))(function (v1) {
              if (v1 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              };
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))($foreign.setHTML(v1.value0)(v2)))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      });
                  });
              };
              throw new Error("Failed pattern match at Halogen.Component.Raw line 52, column 50 - line 57, column 16: " + [ v1.constructor.name ]);
          });
      });
      var render = function (s) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.ref(s.elRef) ])([  ]);
      };
      var $$eval = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateHTML)(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
          });
      };
      return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
...
(function(exports) {
      ...
      return function (dictTransport) {
          return function (dictRoleName) {
              return function (dictIsSymbol) {
                  return function (v) {
                      return function (p) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff_AVar["new"](Data_Unit.unit))(function (v1) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff_AVar["new"](Data_List_Types.Nil.value))(function (v2) {
                                  return Control_Bind.bind(Effect_Aff.bindAff)(uOpen(dictTransport)(p))(function (v3) {
                                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Channel(v3, v2, v1));
                                  });
                              });
                          });
                      };
  ...
  var checkLinearity = function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff_AVar.tryTake(v.value2))(function (v2) {
          if (v2 instanceof Data_Maybe.Just) {
              return Data_Functor.map(Effect_Aff.functorAff)(Channel.create(v.value0)(v.value1))(Effect_Aff_AVar["new"](Data_Unit.unit));
          };
          return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error("Linearity exception"));
      });
  };
  var receive = function (dictReceive) {
      return function (dictTransport) {
          return function (dictDecodeJson) {
              return function (v) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(checkLinearity(v))(function (v1) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff_AVar.take(v.value1))(function (v2) {
                          return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                              if (v2 instanceof Data_List_Types.Nil) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff_AVar.put(Data_List_Types.Nil.value)(v.value1))(function () {
                                      return uReceive(dictTransport)(v.value0);
                                  });
                              };
                              if (v2 instanceof Data_List_Types.Cons) {
                                  return Control_Apply.applySecond(Effect_Aff.applyAff)(Effect_Aff_AVar.put(v2.value1)(v.value1))(Control_Applicative.pure(Effect_Aff.applicativeAff)(v2.value0));
                              };
                              throw new Error("Failed pattern match at Scribble.Core line 97, column 8 - line 101, column 41: " + [ v2.constructor.name ]);
                          })())(function (v3) {
                              var v4 = Data_Argonaut_Decode_Class.decodeJson(dictDecodeJson)(v3);
                              if (v4 instanceof Data_Either.Left) {
                                  return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error(v4.value0));
                              };
                              if (v4 instanceof Data_Either.Right) {
                                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Tuple.Tuple(v4.value0, v1));
                              };
                              throw new Error("Failed pattern match at Scribble.Core line 102, column 3 - line 104, column 34: " + [ v4.constructor.name ]);
                          });
                      });
                  });
              };
              ...
              return function (dictTransport) {
                  return function (dictEncodeJson) {
                      return function (v) {
                          return function (x) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(checkLinearity(v))(function (v1) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(uSend(dictTransport)(v.value0)(Data_Argonaut_Encode_Class.encodeJson(dictEncodeJson)(x)))(function () {
                                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(v1);
                                  });
                              });
                          };
...
(function(exports) {
  ...
  var Type_Proxy = PS["Type.Proxy"];
  var Type_Row = PS["Type.Row"];                 
  var paranoid = function (h) {
      return function (x) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.attempt(x))(function (v) {
              if (v instanceof Data_Either.Left) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(h(v.value0))(function () {
              ...
              throw new Error("Failed pattern match at Scribble.Halogen line 43, column 3 - line 47, column 22: " + [ v.constructor.name ]);
          });
      };
  };
  var halogenSession = function (dictTransport) {
                                  ...
                                  return function (query) {
                                      return function (handler) {
                                          return function (prog) {
                                              return Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorAwait)(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Free_Trans.monadTransFreeT(Control_Coroutine.functorAwait))(Effect_Aff.monadAff)(Scribble_Core.open(dictInitial)(dictTransport)(dictRoleName)(dictIsSymbol)(r)(params)))(function (v1) {
                                                  return Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorAwait)(Effect_Aff.monadAff))(Control_Monad_Free_Trans.hoistFreeT(Control_Coroutine.functorAwait)(Effect_Aff.functorAff)(paranoid(handler))(prog(v1)))(function (v2) {
                                                      return Control_Monad_Trans_Class.lift(Control_Monad_Free_Trans.monadTransFreeT(Control_Coroutine.functorAwait))(Effect_Aff.monadAff)(Scribble_Core.close(dictTerminal)(dictTransport)(r)(v2));
                                                  });
                                              });
                                          };
                                      };
  ...
  exports["halogenSession"] = halogenSession;
  exports["paranoid"] = paranoid;
})(PS["Scribble.Halogen"] = PS["Scribble.Halogen"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Data_Argonaut_Core = PS["Data.Argonaut.Core"];
  ...
  var Scribble_FSM = PS["Scribble.FSM"];
  var Scribble_Type_SList = PS["Scribble.Type.SList"];
  var ScribblePlayground = PS["ScribblePlayground"];
  var Type_Row = PS["Type.Row"];                 
  var Verify = (function () {
      function Verify(value0) {
          this.value0 = value0;
      };
      Verify.create = function (value0) {
          return new Verify(value0);
      };
      return Verify;
  })();
  var QResult = (function () {
      function QResult(value0) {
          this.value0 = value0;
      };
      QResult.create = function (value0) {
          return new QResult(value0);
      };
      return QResult;
  })();
  var Project = (function () {
      function Project(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Project.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Project(value0, value1, value2);
              };
          };
      };
      return Project;
  ...
  var FSM = (function () {
      function FSM(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      FSM.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new FSM(value0, value1, value2);
              };
          };
      };
      return FSM;
  ...
  var sendS9Verify = Scribble_FSM.Send;
  var sendS9Project = Scribble_FSM.Send;
  var sendS9FSM = Scribble_FSM.Send;
  var selectS9 = Scribble_FSM.Select;
  var roleNameServer = Scribble_FSM.RoleName;
  var roleNameClient = Scribble_FSM.RoleName;
  var receiveS13 = Scribble_FSM.Receive;
  var receiveS12 = Scribble_FSM.Receive;
  var receiveS11 = Scribble_FSM.Receive;   
  var initialClient = Scribble_FSM.Initial;
  var genericVerify = new Data_Generic_Rep.Generic(function (x) {
      return x.value0;
  }, function (x) {
      return new Verify(x);
  });
  var genericQResult = new Data_Generic_Rep.Generic(function (x) {
      return x.value0;
  }, function (x) {
      return new QResult(x);
  });
  var genericProject = new Data_Generic_Rep.Generic(function (x) {
      return new Data_Generic_Rep.Product(x.value0, new Data_Generic_Rep.Product(x.value1, x.value2));
  }, function (x) {
      return new Project(x.value0, x.value1.value0, x.value1.value1);
  });
  var genericFSM = new Data_Generic_Rep.Generic(function (x) {
      return new Data_Generic_Rep.Product(x.value0, new Data_Generic_Rep.Product(x.value1, x.value2));
  }, function (x) {
      return new FSM(x.value0, x.value1.value0, x.value1.value1);
  });
  var encodeJsonVerify = new Data_Argonaut_Encode_Class.EncodeJson(Data_Argonaut_Encode_Generic_Rep.genericEncodeJson(genericVerify)(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
      return "Verify";
  }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeJsonJString))));                                                                                           
  var encodeJsonProject = new Data_Argonaut_Encode_Class.EncodeJson(Data_Argonaut_Encode_Generic_Rep.genericEncodeJson(genericProject)(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
      return "Project";
  }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsProduct(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeJsonJString))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsProduct(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeJsonJString))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeJsonJString))))));
  var encodeJsonFSM = new Data_Argonaut_Encode_Class.EncodeJson(Data_Argonaut_Encode_Generic_Rep.genericEncodeJson(genericFSM)(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
      return "FSM";
  }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsProduct(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeJsonJString))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsProduct(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeJsonJString))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeJsonJString))))));
  var decodeJsonQResult = new Data_Argonaut_Decode_Class.DecodeJson(Data_Argonaut_Decode_Generic_Rep.genericDecodeJson(genericQResult)(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructor(new Data_Symbol.IsSymbol(function () {
      return "QResult";
  }))(Data_Argonaut_Decode_Generic_Rep.decodeRepArgsArgument(Data_Argonaut_Decode_Class.decodeJsonEither(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.decodeJsonString)))));
  exports["Project"] = Project;
  exports["FSM"] = FSM;
  exports["QResult"] = QResult;
  exports["Verify"] = Verify;
  exports["genericProject"] = genericProject;
  exports["encodeJsonProject"] = encodeJsonProject;
  exports["genericFSM"] = genericFSM;
  exports["encodeJsonFSM"] = encodeJsonFSM;
  exports["genericQResult"] = genericQResult;
  exports["decodeJsonQResult"] = decodeJsonQResult;
  exports["genericVerify"] = genericVerify;
  exports["encodeJsonVerify"] = encodeJsonVerify;
  exports["roleNameClient"] = roleNameClient;
  exports["initialClient"] = initialClient;
  exports["terminalClient"] = terminalClient;
  exports["sendS9Verify"] = sendS9Verify;
  exports["sendS9Project"] = sendS9Project;
  exports["sendS9FSM"] = sendS9FSM;
  exports["selectS9"] = selectS9;
  exports["receiveS11"] = receiveS11;
  exports["receiveS12"] = receiveS12;
  exports["receiveS13"] = receiveS13;
  exports["roleNameServer"] = roleNameServer;
})(PS["Scribble.Protocol.Playground.LanguageServer"] = PS["Scribble.Protocol.Playground.LanguageServer"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Web_Event_Event = PS["Web.Event.Event"];                 
...
(function(exports) {
  ...
  var send = function (v) {
      return function (x) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff_AVar.read(v.value0))(function (v1) {
              if (v1 instanceof Open) {
                  return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Web_Socket_WebSocket.sendString(v.value2)(Data_Argonaut_Core.stringify(x)));
              };
              if (v1 instanceof Closed) {
                  return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error("Channel is closed"));
              };
              throw new Error("Failed pattern match at Scribble.WebSocket line 101, column 3 - line 105, column 1: " + [ v1.constructor.name ]);
          });
      };
  };
  var receive = function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff_AVar.read(v.value0))(function (v1) {
          if (v1 instanceof Open) {
              return Effect_Aff_AVar.take(v.value1);
          };
          if (v1 instanceof Closed) {
              return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error("Channel is closed"));
          };
          throw new Error("Failed pattern match at Scribble.WebSocket line 108, column 3 - line 112, column 1: " + [ v1.constructor.name ]);
      });
  };
  var modifyVar = function (f) {
      return function (v) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff_AVar.take(v))(function (v1) {
              return Effect_Aff_AVar.put(f(v1))(v);
          });
      };
  };
  var open = function (v) {
      var readHelper = function (read) {
          return function ($44) {
              return Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(Control_Monad_Except.runExcept(read(Foreign.unsafeToForeign($44))));
          };
      };
      var receiveListener = function (ibuf) {
          return Web_Event_EventTarget.eventListener(function (ev) {
              return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Web_Socket_Event_MessageEvent.fromEvent(ev))(function (msgEvent) {
                  return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(readHelper(Foreign.readString)(Web_Socket_Event_MessageEvent.data_(msgEvent)))(function (msg) {
                      return Data_Either.either(function (e) {
                          ...
                          return Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff(Data_Function.flip(Effect_Aff_AVar.put)(ibuf)($45)));
      ...
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff_AVar.empty)(function (v1) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff_AVar.empty)(function (v2) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Web_Socket_WebSocket.create(v.value0)([  ])))(function (v3) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
                      var v4 = receiveListener(v2)();
                      return Web_Event_EventTarget.addEventListener(Web_Socket_Event_EventTypes.onMessage)(v4)(false)(Web_Socket_WebSocket.toEventTarget(v3))();
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
                          var v4 = Web_Event_EventTarget.eventListener(function (v4) {
                              return Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("open")))(function () {
                                  return Effect_Aff_AVar.put(Open.value)(v1);
                              })));
                          })();
                          return Web_Event_EventTarget.addEventListener(Web_Socket_Event_EventTypes.onOpen)(v4)(false)(Web_Socket_WebSocket.toEventTarget(v3))();
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
                              var v4 = Web_Event_EventTarget.eventListener(function (v4) {
                                  return Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("close")))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(modifyVar(Data_Function["const"](Closed.value))(v1))(function () {
                                          return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error("Connection closed"));
                                      });
                                  })));
                              })();
                              return Web_Event_EventTarget.addEventListener(Web_Socket_Event_EventTypes.onClose)(v4)(false)(Web_Socket_WebSocket.toEventTarget(v3))();
                          }))(function () {
                              return Control_Applicative.pure(Effect_Aff.applicativeAff)(new WebSocket(v1, v2, v3));
                          });
                      });
                  });
              });
  ...
  var close = function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff_AVar.read(v.value0))(function (v1) {
          if (v1 instanceof Open) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(modifyVar(Data_Function["const"](Closed.value))(v.value0))(function () {
                  return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Web_Socket_WebSocket.close(v.value2));
              });
          };
          if (v1 instanceof Closed) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit);
          };
          throw new Error("Failed pattern match at Scribble.WebSocket line 115, column 3 - line 119, column 24: " + [ v1.constructor.name ]);
      });
  };
...
(function(exports) {
  ...
  var Effect_Class = PS["Effect.Class"];
  var Effect_Class_Console = PS["Effect.Class.Console"];
  var Graphics_Viz = PS["Graphics.Viz"];
  var Halogen = PS["Halogen"];
  var Halogen_Aff = PS["Halogen.Aff"];
  var Halogen_Aff_Util = PS["Halogen.Aff.Util"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_Component_ChildPath = PS["Halogen.Component.ChildPath"];
  var Halogen_Component_Raw = PS["Halogen.Component.Raw"];
  var Halogen_HTML = PS["Halogen.HTML"];
  ...
  var Scribble_Core = PS["Scribble.Core"];
  var Scribble_FSM = PS["Scribble.FSM"];
  var Scribble_Halogen = PS["Scribble.Halogen"];
  var Scribble_Protocol_Playground_LanguageServer = PS["Scribble.Protocol.Playground.LanguageServer"];
  ...
  var FSM = (function () {
      ...
      FSM.create = function (value0) {
          return new FSM(value0);
      };
      return FSM;
  })();
  var Projection = (function () {
      function Projection(value0) {
          this.value0 = value0;
      };
      Projection.create = function (value0) {
          return new Projection(value0);
      };
      return Projection;
  })();
  ...
  var VerifyM = (function () {
      function VerifyM(value0) {
          this.value0 = value0;
      };
      VerifyM.create = function (value0) {
          return new VerifyM(value0);
      };
      return VerifyM;
  })();
  var ProjectM = (function () {
      function ProjectM(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      ProjectM.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new ProjectM(value0, value1, value2);
              };
          };
      };
      return ProjectM;
  ...
  var FSMM = (function () {
      function FSMM(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      FSMM.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new FSMM(value0, value1, value2);
              };
          };
      };
      return FSMM;
  ...
  var ResultEvent = (function () {
      function ResultEvent(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ResultEvent.create = function (value0) {
          return function (value1) {
              return new ResultEvent(value0, value1);
          };
      };
      return ResultEvent;
  })();
  var PerformQuery = (function () {
      function PerformQuery(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      PerformQuery.create = function (value0) {
          return function (value1) {
              return new PerformQuery(value0, value1);
          };
      };
      return PerformQuery;
  })();
  ...
  var UpdateProtocolName = (function () {
      function UpdateProtocolName(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateProtocolName.create = function (value0) {
          return function (value1) {
              return new UpdateProtocolName(value0, value1);
          };
      };
      return UpdateProtocolName;
  })();
  var UpdateRoleName = (function () {
      function UpdateRoleName(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateRoleName.create = function (value0) {
          return function (value1) {
              return new UpdateRoleName(value0, value1);
          };
      };
  ...
  var eqResult = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof FSM && y instanceof FSM) {
              return x.value0 === y.value0;
          };
          if (x instanceof Projection && y instanceof Projection) {
              return x.value0 === y.value0;
          };
          if (x instanceof Verified && y instanceof Verified) {
              return true;
          };
  ...
  var eqMode = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof Ready && y instanceof Ready) {
              return Data_Eq.eq(Data_Either.eqEither(Data_Eq.eqString)(eqResult))(x.value0)(y.value0);
          };
          if (x instanceof Working && y instanceof Working) {
              return true;
          };
  ...
  var ui = (function () {
      ...
      var render = function (v) {
          var result = (function () {
              if (v.mode instanceof Connecting) {
                  return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Connecting...") ]);
              };
              if (v.mode instanceof Ready && v.mode.value0 instanceof Data_Either.Left) {
                  return Halogen_HTML_Elements.p([ Halogen_HTML_CSS.style(CSS_Font.color(Color_Scheme_Clrs.red)) ])([ Halogen_HTML_Core.text("Error: " + v.mode.value0.value0) ]);
              };
              if (v.mode instanceof Ready && (v.mode.value0 instanceof Data_Either.Right && v.mode.value0.value0 instanceof Connected)) {
                  return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Connected :)") ]);
              };
              if (v.mode instanceof Ready && (v.mode.value0 instanceof Data_Either.Right && v.mode.value0.value0 instanceof Verified)) {
                  return Halogen_HTML_Elements.h3([ Halogen_HTML_CSS.style(CSS_Font.color(Color_Scheme_Clrs.green)) ])([ Halogen_HTML_Core.text("Verified!") ]);
              };
              if (v.mode instanceof Ready && (v.mode.value0 instanceof Data_Either.Right && v.mode.value0.value0 instanceof FSM)) {
                  return Halogen_HTML_Elements.div_([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Halogen_Component_Raw.rawComponent)({
                      html: Graphics_Viz.viz(v.mode.value0.value0.value0)(Graphics_Viz.SVG.value),
                      elRef: "fsm"
                  })(Data_Function["const"](Data_Maybe.Nothing.value)) ]);
              };
              if (v.mode instanceof Ready && (v.mode.value0 instanceof Data_Either.Right && v.mode.value0.value0 instanceof Projection)) {
                  return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(v.mode.value0.value0.value0) ]);
              };
              if (v.mode instanceof Working) {
                  return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Working...") ]);
              };
              if (v.mode instanceof Disconnected) {
                  return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("The connection has been lost, please refresh the page.") ]);
              };
              throw new Error("Failed pattern match at Main line 142, column 14 - line 150, column 97: " + [ v.mode.constructor.name ]);
          })();
          var enabled = Halogen_HTML_Properties.enabled(Data_Eq.notEq(eqMode)(v.mode)(Working.value));
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Scribble Playground") ]), Halogen_HTML_Elements.div_([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(AceSlot.value)(AceComponent.aceComponent)(Data_Unit.unit)(handleAceOutput) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Protocol:"), Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(UpdateProtocolName.create)) ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Role:"), Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(UpdateRoleName.create)) ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(PerformQuery.create(new VerifyM(v.text)))), enabled ])([ Halogen_HTML_Core.text("Verify") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(PerformQuery.create(new ProjectM(v.text, v.role, v.protocol)))), enabled ])([ Halogen_HTML_Core.text("Project") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(PerformQuery.create(new FSMM(v.text, v.role, v.protocol)))), enabled ])([ Halogen_HTML_Core.text("Generate FSM") ]) ]) ]), result ]);
      };
      var $$eval = function (v) {
          if (v instanceof ResultEvent) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $77.mode = new Ready(v.value0);
                  return $77;
              }))(function (v1) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof PerformQuery) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $82 = {};
                  for (var $83 in v1) {
          ...
          if (v instanceof UpdateProtocolName) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $92 = {};
                  for (var $93 in v1) {
                  ...
                  $92.protocol = v.value0;
                  return $92;
              }))(function (v1) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof UpdateRoleName) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $97 = {};
                  for (var $98 in v1) {
          ...
          if (v instanceof Disconnect) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $102.mode = Disconnected.value;
                  return $102;
              }))(function (v1) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Main line 153, column 3 - line 153, column 76: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Either.ordEither(ordAceSlot)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Ord.ordVoid)))({
          initialState: Data_Function["const"](initialState),
          render: render,
          "eval": $$eval,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
  ...
  var app = function (query) {
      var loop = function (c) {
          return Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorAwait)(Effect_Aff.monadAff))(Control_Coroutine["await"](Effect_Aff.monadAff))(function (v) {
              return Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorAwait)(Effect_Aff.monadAff))((function () {
                  if (v instanceof VerifyM) {
                      return Control_Monad_Trans_Class.lift(Control_Monad_Free_Trans.monadTransFreeT(Control_Coroutine.functorAwait))(Effect_Aff.monadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Scribble_Core.select(Scribble_Protocol_Playground_LanguageServer.selectS9)(Scribble_Core.elemTail(Scribble_Core.elemTail(Scribble_Core.elemHead)))(c)(Data_Symbol.SProxy.value))(function (v1) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Scribble_Core.send(Scribble_Protocol_Playground_LanguageServer.sendS9Verify)(Scribble_Protocol_Playground_LanguageServer.roleNameServer)(new Data_Symbol.IsSymbol(function () {
                              return "Server";
                          }))(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Playground_LanguageServer.encodeJsonVerify)(v1)(new Scribble_Protocol_Playground_LanguageServer.Verify(v.value0)))(function (v2) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(Scribble_Core.receive(Scribble_Protocol_Playground_LanguageServer.receiveS11)(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Playground_LanguageServer.decodeJsonQResult)(v2))(function (v3) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(query(Halogen_Query.action(ResultEvent.create(Data_Either.either(Data_Either.Left.create)(function ($136) {
                                      return Data_Either.Right.create(Data_Function["const"](Verified.value)($136));
                                  })(v3.value0.value0)))))(function () {
                                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(v3.value1);
                                  });
                              });
                          });
                      }));
                  };
                  if (v instanceof ProjectM) {
                      return Control_Monad_Trans_Class.lift(Control_Monad_Free_Trans.monadTransFreeT(Control_Coroutine.functorAwait))(Effect_Aff.monadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Scribble_Core.select(Scribble_Protocol_Playground_LanguageServer.selectS9)(Scribble_Core.elemHead)(c)(Data_Symbol.SProxy.value))(function (v1) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Scribble_Core.send(Scribble_Protocol_Playground_LanguageServer.sendS9Project)(Scribble_Protocol_Playground_LanguageServer.roleNameServer)(new Data_Symbol.IsSymbol(function () {
                              return "Server";
                          }))(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Playground_LanguageServer.encodeJsonProject)(v1)(new Scribble_Protocol_Playground_LanguageServer.Project(v.value0, v.value1, v.value2)))(function (v2) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(Scribble_Core.receive(Scribble_Protocol_Playground_LanguageServer.receiveS12)(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Playground_LanguageServer.decodeJsonQResult)(v2))(function (v3) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(query(Halogen_Query.action(ResultEvent.create(Data_Either.either(Data_Either.Left.create)(function ($137) {
                                      return Data_Either.Right.create(Projection.create($137));
                                  })(v3.value0.value0)))))(function () {
                                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(v3.value1);
                                  });
                              });
                  ...
                  if (v instanceof FSMM) {
                      return Control_Monad_Trans_Class.lift(Control_Monad_Free_Trans.monadTransFreeT(Control_Coroutine.functorAwait))(Effect_Aff.monadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Scribble_Core.select(Scribble_Protocol_Playground_LanguageServer.selectS9)(Scribble_Core.elemTail(Scribble_Core.elemHead))(c)(Data_Symbol.SProxy.value))(function (v1) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Scribble_Core.send(Scribble_Protocol_Playground_LanguageServer.sendS9FSM)(Scribble_Protocol_Playground_LanguageServer.roleNameServer)(new Data_Symbol.IsSymbol(function () {
                              return "Server";
                          }))(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Playground_LanguageServer.encodeJsonFSM)(v1)(new Scribble_Protocol_Playground_LanguageServer.FSM(v.value0, v.value2, v.value1)))(function (v2) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(Scribble_Core.receive(Scribble_Protocol_Playground_LanguageServer.receiveS13)(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Playground_LanguageServer.decodeJsonQResult)(v2))(function (v3) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(query(Halogen_Query.action(ResultEvent.create(Data_Either.either(Data_Either.Left.create)(function ($138) {
                                      return Data_Either.Right.create(FSM.create($138));
                                  })(v3.value0.value0)))))(function () {
                                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(v3.value1);
                                  });
                              });
                  ...
                  throw new Error("Failed pattern match at Main line 202, column 10 - line 220, column 15: " + [ v.constructor.name ]);
              })())(function (v1) {
                  return loop(v1);
              });
          });
      };
      return Scribble_Halogen.halogenSession(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Playground_LanguageServer.initialClient)(Scribble_Protocol_Playground_LanguageServer.terminalClient)(Scribble_Protocol_Playground_LanguageServer.roleNameClient)(new Data_Symbol.IsSymbol(function () {
          return "Client";
      }))(Type_Proxy["Proxy"].value)(Scribble_FSM.Role.value)(Scribble_WebSocket.URL.create("ws://0.0.0.0:9160"))(query)(Data_Function["const"](query(Halogen_Query.action(Disconnect.create))))(function (c) {
          return Control_Apply.applySecond(Control_Monad_Free_Trans.applyFreeT(Control_Coroutine.functorAwait)(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Free_Trans.monadTransFreeT(Control_Coroutine.functorAwait))(Effect_Aff.monadAff)(query(Halogen_Query.action(ResultEvent.create(new Data_Either.Right(Connected.value))))))(loop(c));
      });
  };
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(ui)(Data_Unit.unit)(v))(function (v1) {
          return v1.subscribe(app(v1.query));
      });
  }));
  ...
  exports["UpdateProtocolName"] = UpdateProtocolName;
